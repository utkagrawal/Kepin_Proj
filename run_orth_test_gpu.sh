#!/bin/bash
# run_orth_test_gpu.sh
#SBATCH --partition=gpu-P100
#SBATCH --nodelist=gpu-P100-01
#SBATCH --job-name=orth_reg
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --time=24:00:00
#SBATCH --output=orth_test_gpu.log
...
mkdir -p ~/Kepin_code/experiments_result/phase11/fd002_orth_reg
...
python -u kepin_cmapss_optimized.py \
    ...
    --epochs 30 \
    --n_runs 1 \
    --output_dir experiments_result/phase11/fd002_orth_reg

cp -r experiments_result/phase11/fd002_orth_reg ~/Kepin_code/experiments_result/phase11/
echo "Orth test on GPU finished"
