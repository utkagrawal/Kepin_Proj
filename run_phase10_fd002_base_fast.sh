#!/bin/bash
# run_phase10_fd002_base_fast.sh
#SBATCH --partition=gpu-P100
#SBATCH --nodelist=gpu-P100-02
#SBATCH --job-name=fd002_bas_f
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --time=24:00:00
#SBATCH --output=phase10_fd002_base_fast.log
...
mkdir -p ~/Kepin_code/experiments_result/phase10/fd002_base_fast
...
python -u kepin_cmapss_optimized.py \
    ...
    --epochs 10 \
    --n_runs 1 \
    --output_dir experiments_result/phase10/fd002_base_fast

cp -r experiments_result/phase10/fd002_base_fast ~/Kepin_code/experiments_result/phase10/
echo "FD002 Fast Base finished"
