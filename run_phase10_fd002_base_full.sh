#!/bin/bash
# run_phase10_fd002_base_full.sh
#SBATCH --partition=gpu-P100
#SBATCH --nodelist=gpu-P100-02
#SBATCH --job-name=fd002_bas_250
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --time=24:00:00
#SBATCH --output=phase10_fd002_base_full.log
...
mkdir -p ~/Kepin_code/experiments_result/phase10/fd002_final_base
...
python -u kepin_cmapss_optimized.py \
    ...
    --output_dir experiments_result/phase10/fd002_final_base

cp -r experiments_result/phase10/fd002_final_base ~/Kepin_code/experiments_result/phase10/
echo "FD002 Full Base finished"
